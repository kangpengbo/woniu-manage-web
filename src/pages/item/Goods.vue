  ...
  <v-card>
    ...
    >
      <template slot="items" slot-scope="props">
        ...
        <td class="text-xs-center">{{ props.item.pnum}}</td>
        <td class="text-xs-center">{{ props.item.imgurl }}</td>
  ...
  export default {
    ...
    data() {
      return {
        ...
        pagination: {},// 分页信息
        headers: [// 表头
          {text: 'productid', align: 'center', value: 'id'},
          {text: 'name', align: 'center', value: 'id'},
          {text: 'author', align: 'center', value: 'id'},
          {text: 'publisher', align: 'center', value: 'id'},
          {text: 'price', align: 'center', value: 'id'},
          {text: 'typeid', align: 'center', value: 'id'},
          {text: 'pnum', align: 'center', value: 'id'},
          {text: 'imgurl', align: 'center', value: 'id'},
        ],
        show: false,// 是否弹出窗口
